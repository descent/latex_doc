...
\hypersetup{%
  ...
  pdftitle={bootloader code},
  pdfauthor={Aleph1},
  pdfsubject={bootloader},
  pdfkeywords={stack},
  pdfcreator={应用程序},
...
\section{fat12\_{}bl.S}
\lstinputlisting[basicstyle=\footnotesize,frame=single,frameround=tttt,breaklines=true,title=fat12\_{}bl.S]{fat12_bl.S}
