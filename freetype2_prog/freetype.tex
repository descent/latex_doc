...
%\lstinputlisting[frame=single,frameround=tttt,breaklines=true, language={[ANSI]C}, escapeinside={@}{@}, title=sample1]{qstring_utf8/main.cpp}

%\VerbatimInput[fontfamily=tt,fontsize=\footnotesize,frame=lines, framerule=0.4mm, numbers=left, numbersep=3pt, tabsize=2, firstline=1, lastline=99]{qstring_utf8/main.cpp}

\VerbatimInput[fontfamily=tt,fontsize=\footnotesize,frame=lines, framerule=0.4mm, numbers=left, numbersep=3pt, tabsize=2]{qstring_utf8/main.cpp}

\lstinputlisting[frame=single,frameround=tttt,breaklines=true, title=makefile]{qstring_utf8/makefile}

\newpage
\lstinputlisting[frame=single,frameround=tttt,breaklines=true, title=執行結果, label=lst::result]{qstring_utf8/ret}
