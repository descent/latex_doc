...
\usepackage[paperwidth=10.1cm,paperheight=13cm,left=0.8cm,right=0.7cm,bottom=1.0cm,top=0.1cm,nohead,nofoot]{geometry}
...
\lstinputlisting[basicstyle=\footnotesize,frame=single,frameround=tttt,breaklines=true,title=modify a little version]{code/shellcodeasm.c}
...
%eggshell.c
\begin{lstlisting}[caption=eggshell.c,frame=single,frameround=tttt,numbers=left,breaklines=true]
